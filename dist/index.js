...
const fs = __importStar(__nccwpck_require__(7147)); // Using fs.promises for async file operations
...
const download_jar_1 = __nccwpck_require__(3907);
/**
...
async function run() {
    try {
        const WS_APIKEY = core.getInput('WS_APIKEY');
        const WS_USERKEY = core.getInput('WS_USERKEY');
        const WS_PRODUCTNAME = core.getInput('WS_PRODUCTNAME');
        ...
        await (0, download_jar_1.downloadFile)();
        (0, child_process_1.exec)('java -jar wss-unified-agent.jar', (error, stdout, stderr) => {
            if (error) {
